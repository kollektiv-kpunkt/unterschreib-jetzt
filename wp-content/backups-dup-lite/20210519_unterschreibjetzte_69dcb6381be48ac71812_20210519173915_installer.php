...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210519_unterschreibjetzte_69dcb6381be48ac71812_20210519173915_archive.zip';
	const ARCHIVE_SIZE		 = '76045051';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '69dcb63-19173915';
    const SECONDARY_PACKAGE_HASH = '7b92484-19173915';
	const VERSION			 = '1.4.0';
